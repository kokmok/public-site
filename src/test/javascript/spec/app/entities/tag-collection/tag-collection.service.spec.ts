...
import { ITagCollection, TagCollection } from 'app/shared/model/tag-collection.model';
...
describe('Service Tests', () => {
  describe('TagCollection Service', () => {
    ...
    let elemDefault: ITagCollection;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(TagCollectionService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new TagCollection(0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a TagCollection', () => {
        ...
        service.create(new TagCollection()).subscribe(resp => (expectedResult = resp.body));
